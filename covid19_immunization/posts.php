...
$geo_city = strip_tags($_POST['geo_city']);
$vaccine_no = strip_tags($_POST['vaccine_no']);
$vaccine_appointment_request =0;
...
$latitude_field =14;
$longitude_field =15;
//$total_comments_field =16;

$vaccine_appointment_request_field=16;
$vaccine_available_field=17;
$post_type_field=18;
$vaccination_city_field=19;
...
"'.$vaccine_appointment_request_field.'": {
        "value": "0"
      },
"'.$vaccine_available_field.'": {
        "value": "'.$vaccine_no.'"
      },
"'.$post_type_field.'": {
        "value": "vaccination"
      },
"'.$vaccination_city_field.'": {
        "value": "'.$geo_city.'"
      }
