...
localStorage.setItem('useridsessdata2', '$userid');
localStorage.setItem('fullnamesessdata2', '$fullname');
localStorage.setItem('usernamesessdata2', '$username');
localStorage.setItem('emailsessdata2', '$email');
localStorage.setItem('photosessdata2', '$photo');
localStorage.setItem('userranksessdata2', '$user_rank');


localStorage.setItem('titleheader2', 'Covid19 Immunization');
localStorage.setItem('titlefooter2', 'Covid19 Immunisation and Vaccination System Powered by Quickbase. ');
localStorage.setItem('appcolor2', '#ec5574');


localStorage.setItem('secuserid2', '$userid');
localStorage.setItem('secfullname2', '$fullname');
localStorage.setItem('secemail2', '$email');
</script>";
...
//echo "<script>window.location='dashboard_welcome1.html'</script>";

echo "<script>window.location='security_verify.html'</script>";
